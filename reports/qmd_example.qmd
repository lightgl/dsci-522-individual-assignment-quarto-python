...
We can see from @fig-pop <!--Figure 1--> that Ontario, Saskatchewan and Alberta 
...
We present the standard deviations in @tbl-sd <!--Table 1-->.
...
Additionally, note that in @tbl-sd <!--Table 1-->we consider the sample standard deviation of the number of horses during the same time span as @fig-pop <!-- Figure 1-->.

![Horse populations for the province with the largest standard deviation](../results/horse_pops_plot_largest_sd.png){#fig-pop2}

<!--Figure 2: Horse populations for the province with the largest standard deviation-->

In @fig-pop2 <!--Figure 2--> we zoom in and look at the province of `{python} largest_sd`, which had the largest spread of values in terms of standard deviation.
